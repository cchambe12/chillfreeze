...
dvrbar <- subset(chillfrz, select=c("species", "chill", "dvr", "tx", "budburst"))
dvrbar <- na.omit(dvrbar)
dvrbar <- dvrbar[!duplicated(dvr),]
...
chill.bars4$dvrmean <- ave(chill.bars4$dvr, chill.bars4$tx, chill.bars4$species)
chill.bars4$dvrsd <- ave(chill.bars4$dvr, chill.bars4$tx, chill.bars4$species, FUN=sd)
chill.bars4$ymin <- chill.bars4$dvrmean-chill.bars4$dvrsd
chill.bars4$ymax <- chill.bars4$dvrmean+chill.bars4$dvrsd
chill.bars4$meancont <- mean(chill.bars4$dvr[chill.bars4$tx=="control"]) # 16.0
chill.bars4$meantx <- mean(chill.bars4$dvr[chill.bars4$tx=="treatment"]) # 18.8
...
chill.bars6$meancont <- mean(chill.bars6$dvr[chill.bars6$tx=="control"]) #15.4
chill.bars6$meantx <- mean(chill.bars6$dvr[chill.bars6$tx=="treatment"]) #17.5
...
chill.bars8$dvrsd <- ave(chill.bars8$dvr, chill.bars8$tx, chill.bars8$species, FUN=sd)
chill.bars8$ymin <- chill.bars8$dvrmean-chill.bars8$dvrsd
chill.bars8$ymax <- chill.bars8$dvrmean+chill.bars8$dvrsd
chill.bars8$meancont <- mean(chill.bars8$dvr[chill.bars8$tx=="control"]) #13.2
chill.bars8$meantx <- mean(chill.bars8$dvr[chill.bars8$tx=="treatment"]) #16.9
