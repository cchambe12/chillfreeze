...
model {
	...
	//b_txchill2_ncp ~ skew_normal(0, 50, 10);
        ...
        mu_a_sp ~ skew_normal(0, 50, 10);
        sigma_a_sp ~ skew_normal(0, 10, 5);

        mu_b_tx_sp ~ skew_normal(0, 50, 10);
        sigma_b_tx_sp ~ skew_normal(0, 10, 5);
        mu_b_chill1_sp ~ skew_normal(0, 50, 10);
        sigma_b_chill1_sp ~ skew_normal(0, 10, 5);
        mu_b_chill2_sp ~ skew_normal(0, 50, 10);
        sigma_b_chill2_sp ~ skew_normal(0, 10, 5);
        mu_b_txchill1_sp ~ skew_normal(0, 50, 10);
        sigma_b_txchill1_sp ~ skew_normal(0, 10, 5);

        mu_b_txchill2_sp ~ skew_normal(0, 50, 10);
