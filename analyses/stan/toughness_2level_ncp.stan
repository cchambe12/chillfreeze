...
parameters {
  ...
  vector[n_sp] b_txchill2_ncp; // slope of lat effect
...
model {
	...
	b_txchill1_ncp ~ normal(0, 1);
	b_txchill1_ncp ~ normal(0, 1);

        mu_a_sp ~ normal(0, 10);
        sigma_a_sp ~ normal(0, 5);

        mu_b_tx_sp ~ normal(0, 10);
        sigma_b_tx_sp ~ normal(0, 5);
        mu_b_chill1_sp ~ normal(0, 10);
        sigma_b_chill1_sp ~ normal(0, 5);
        mu_b_chill2_sp ~ normal(0, 10);
        sigma_b_chill2_sp ~ normal(0, 5);
        mu_b_txchill1_sp ~ normal(0, 10);
        sigma_b_txchill1_sp ~ normal(0, 5);

        mu_b_txchill2_sp ~ normal(0, 10);
