...
model {
	...
	//b_txchill1_ncp ~ skew_normal(0, 20, 5);
	//b_txchill2_ncp ~ skew_normal(0, 20, 5);

        mu_a_sp ~ skew_normal(0, 50, 20);
        sigma_a_sp ~ skew_normal(0, 5, 10);

        mu_b_tx_sp ~ skew_normal(0, 50, 20);
        sigma_b_tx_sp ~ skew_normal(0, 5, 10);
        mu_b_chill1_sp ~ skew_normal(0, 50, 20);
        sigma_b_chill1_sp ~ skew_normal(0, 5, 10);
        mu_b_chill2_sp ~ skew_normal(0, 50, 20);
        sigma_b_chill2_sp ~ skew_normal(0, 5, 10);
        mu_b_txchill1_sp ~ skew_normal(0, 50, 20);
        sigma_b_txchill1_sp ~ skew_normal(0, 5, 10);
        mu_b_txchill2_sp ~ skew_normal(0, 50, 20);
        sigma_b_txchill2_sp ~ skew_normal(0, 5, 10);
