...
model {
	...
	b_txdrought1_ncp ~ normal(0, 10);
	b_txdrought2_ncp ~ normal(0, 10);
        ...
        sigma_b_drought1_sp ~ normal(0, 10);
        mu_b_drought2_sp ~ normal(0, 50);
        sigma_b_drought2_sp ~ normal(0, 10);
        mu_b_txdrought1_sp ~ normal(0, 50);
        sigma_b_txdrought1_sp ~ normal(0, 10);
        mu_b_txdrought2_sp ~ normal(0, 50);
        sigma_b_txdrought2_sp ~ normal(0, 10);
