...
parameters {
  ...
  //vector[n_sp] b_txchill1; // slope of lat effect
  //vector[n_sp] b_txchill2; // slope of chill x force effect
...
model {
	...
	b_txchill1_ncp ~ skew_normal(0, 50, 10);
	b_txchill2_ncp ~ skew_normal(0, 50, 10);

        mu_a_sp ~ skew_normal(0, 100, 50);
        sigma_a_sp ~ skew_normal(0, 50, 10);

        mu_b_tx_sp ~ skew_normal(0, 100, 50);
        sigma_b_tx_sp ~ skew_normal(0, 50, 10);
        mu_b_chill1_sp ~ skew_normal(0, 100, 50);
        sigma_b_chill1_sp ~ skew_normal(0, 50, 10);
        mu_b_chill2_sp ~ skew_normal(0, 100, 50);
        sigma_b_chill2_sp ~ skew_normal(0, 50, 10);
        mu_b_txchill1_sp ~ skew_normal(0, 100, 50);
        sigma_b_txchill1_sp ~ skew_normal(0, 50, 10);
        mu_b_txchill2_sp ~ skew_normal(0, 100, 50);
        sigma_b_txchill2_sp ~ skew_normal(0, 50, 10);
