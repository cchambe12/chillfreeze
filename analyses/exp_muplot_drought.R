...
axis(2, at=1:9, labels=rev(c("Treatment", "Chilling \n(6 weeks)", "Chilling  \n(8 weeks)",
                             "Drought1", "Drought2",
                             "Treatment x \nChilling \n(6 weeks)", "Treatment x \nChilling \n(8 weeks)",
                             "Treatment x \nDrought1", "Treatment x \nDrought2" )), las=1)
abline(v=0, lty=2, col="darkgrey")
rownameshere <- c("mu_b_tx_sp", "mu_b_chill1_sp", "mu_b_chill2_sp",
                  "mu_b_drought1_sp", "mu_b_drought2_sp", "mu_b_txchill1_sp", "mu_b_txchill2_sp",
                  "mu_b_txdrought1_sp", "mu_b_txdrought2_sp")
ppeffects <- c("mu_b_tx_sp", "mu_b_chill1_sp", "mu_b_chill2_sp",
               "mu_b_drought1_sp", "mu_b_drought2_sp", "mu_b_txchill1_sp", "mu_b_txchill2_sp",
               "mu_b_txdrought1_sp", "mu_b_txdrought2_sp") # or 1:4 here...
for(i in 1:9){
  pos.y<-(9:1)[i]
...
for(spsi in 1:spnum){
  pos.sps.i<-which(grepl(paste("[",spsi,"]",sep=""),rownames(summary(modelhere)$summary),fixed=TRUE))[2:10]
