...
dvrtx<-as.numeric(format(round(mean(fixef(dvr.mod, pars="tx", summary=FALSE)), digits=1), nsmall=1)) ### 2.97
dvrtxsd<-as.numeric(format(round(mean(fixef(dvr.mod, pars="tx")[2]), digits=1), nsmall=1)) 
dvrchill1<-as.numeric(format(round(mean(fixef(dvr.mod, pars="chill1", summary=FALSE)), digits=1), nsmall=1)) # -0.53
dvrchill1sd<-as.numeric(format(round(mean(fixef(dvr.mod, pars="chill1")[2]), digits=1), nsmall=1))
dvrchill2<-as.numeric(format(round(mean(fixef(dvr.mod, pars="chill2", summary=FALSE)), digits=1), nsmall=1)) ### -2.67
dvrchill2sd<-as.numeric(format(round(mean(fixef(dvr.mod, pars="chill2")[2]), digits=1), nsmall=1)) # 1.14

dvrtxchill1<-as.numeric(format(round(mean(fixef(dvr.mod, pars="tx:chill1", summary=FALSE)), digits=1), nsmall=1)) 
dvrtxchill1sd<-as.numeric(format(round(mean(fixef(dvr.mod, pars="tx:chill1")[2]), digits=1), nsmall=1)) # 1.14
dvrtxchill1 <- round(mean(fixef(dvr.mod, pars="tx", summary=FALSE)) + mean(fixef(dvr.mod, pars="chill1", summary=FALSE)) + mean(fixef(dvr.mod, pars="tx:chill1", summary=FALSE)), digits=1) ### 1.53

dvrtxchill2<-as.numeric(format(round(mean(fixef(dvr.mod, pars="tx:chill2", summary=FALSE)), digits=1), nsmall=1)) 
dvrtxchill2sd<-as.numeric(format(round(mean(fixef(dvr.mod, pars="tx:chill2")[2]), digits=1), nsmall=1)) # 1.08
dvrtxchill2 <- round(mean(fixef(dvr.mod, pars="tx", summary=FALSE)) + mean(fixef(dvr.mod, pars="chill2", summary=FALSE)) + mean(fixef(dvr.mod, pars="tx:chill2", summary=FALSE)), digits=1) # 0.92


### Gslength Model - CHILLING EXTENDS GS!!!! AND CAN COMPENSATE FOR TX!
gslengthtx<-as.numeric(format(round(mean(fixef(gslength.modlo, pars="tx", summary=FALSE)), digits=1), nsmall=1)) # -2.9
gslengthtxsd<-as.numeric(format(round(mean(fixef(gslength.modlo, pars="tx")[2]), digits=1), nsmall=1)) # 5.52
gslengthchill1<-as.numeric(format(round(mean(fixef(gslength.modlo, pars="chill1", summary=FALSE)), digits=1), nsmall=1)) ### 3.11
gslengthchill1sd<-as.numeric(format(round(mean(fixef(gslength.modlo, pars="chill1")[2]), digits=1), nsmall=1)) # 4.97
gslengthchill2<-as.numeric(format(round(mean(fixef(gslength.modlo, pars="chill2", summary=FALSE)), digits=1), nsmall=1)) ### -6.82
gslengthchill2sd<-as.numeric(format(round(mean(fixef(gslength.modlo, pars="chill2")[2]), digits=1), nsmall=1)) # 5.11
gslengthtxchill1<-as.numeric(format(round(mean(fixef(gslength.modlo, pars="tx:chill1", summary=FALSE)), digits=1), nsmall=1)) 
gslengthtxchill1sd<-as.numeric(format(round(mean(fixef(gslength.modlo, pars="tx:chill1")[2]), digits=1), nsmall=1)) # 6.63
gslengthtxchill1 <- round(mean(fixef(gslength.mod, pars="tx", summary=FALSE)) + mean(fixef(gslength.mod, pars="chill1", summary=FALSE)) + mean(fixef(gslength.mod, pars="tx:chill1", summary=FALSE)), digits=1) # -13.91

gslengthtxchill2<-as.numeric(format(round(mean(fixef(gslength.modlo, pars="tx:chill2", summary=FALSE)), digits=1), nsmall=1))
gslengthtxchill2sd<-as.numeric(format(round(mean(fixef(gslength.modlo, pars="tx:chill2")[2]), digits=1), nsmall=1)) # 6.97
gslengthtxchill2 <- round(mean(fixef(gslength.mod, pars="tx", summary=FALSE)) + mean(fixef(gslength.mod, pars="chill2", summary=FALSE)) + mean(fixef(gslength.mod, pars="tx:chill2", summary=FALSE)), digits=1) ### -19.08

### Meristem Model - MERISTEM DAMAGE ACROSS CHILL TXs!!
meritx<-as.numeric(format(round(mean(fixef(meri.mod, pars="tx", summary=FALSE)), digits=1), nsmall=1)) ### 2.07
meritx.perc <- as.numeric(format(round((meritx/4)*100, digits=1), nsmall=1))
meritxsd <- as.numeric(format(round(mean(fixef(meri.mod, pars="tx")[2]), digits=1), nsmall=1)) # 0.97
merichill1<-as.numeric(format(round(mean(fixef(meri.mod, pars="chill1", summary=FALSE)), digits=1), nsmall=1)) # -0.53
merichill1sd<-as.numeric(format(round(mean(fixef(meri.mod, pars="chill1")[2]), digits=1), nsmall=1)) # 1.88
merichill2<-as.numeric(format(round(mean(fixef(meri.mod, pars="chill2", summary=FALSE)), digits=1), nsmall=1)) # -0.18
merichill2sd<-as.numeric(format(round(mean(fixef(meri.mod, pars="chill2")[2]), digits=1), nsmall=1)) # 1.17
#merichill2sd <- merichill2sd[2] - merichill2sd[1]
meritxchill1<-as.numeric(format(round(mean(fixef(meri.mod, pars="tx:chill1", summary=FALSE)), digits=1), nsmall=1)) 
meritxchill1sd<-as.numeric(format(round(mean(fixef(meri.mod, pars="tx:chill1")[2]), digits=1), nsmall=1)) # 1.42
#meritxchill1sd <- meritxchill1sd[2] - meritxchill1sd[1]
meritxchill1 <- round(mean(fixef(meri.mod, pars="tx", summary=FALSE)) + mean(fixef(meri.mod, pars="chill1", summary=FALSE)) + mean(fixef(meri.mod, pars="tx:chill1", summary=FALSE)), digits=1) # 1.33
meritxchill1.perc <- as.numeric(format(round((meritxchill1/4)*100, digits=1), nsmall=1))

meritxchill2<-as.numeric(format(round(mean(fixef(meri.mod, pars="tx:chill2", summary=FALSE)), digits=1), nsmall=1)) 
meritxchill2sd<-as.numeric(format(round(mean(fixef(meri.mod, pars="tx:chill2")[2]), digits=1), nsmall=1)) # 1.31
#meritxchill2sd <- meritxchill2sd[2] - meritxchill2sd[1]
meritxchill2 <- round(mean(fixef(meri.mod, pars="tx", summary=FALSE)) + mean(fixef(meri.mod, pars="chill2", summary=FALSE)) + mean(fixef(meri.mod, pars="tx:chill2", summary=FALSE)), digits=1) ### 2.17
meritxchill2.perc <- as.numeric(format(round((meritxchill2/4)*100, digits=1), nsmall=1))

### Chlo Model ### PROBABLY MOVE TO SUPP!!! TX DECREASES CHLORO ESP WITH MORE CHILLING...
chltx<-as.numeric(format(round(mean(fixef(chl.mod, pars="tx", summary=FALSE)), digits=1), nsmall=1)) # -0.35
chltxsd<-as.numeric(format(round(mean(fixef(chl.mod, pars="tx")[2]), digits=1), nsmall=1)) # 0.77
#chltxsd <- chltxsd[2] - chltxsd[1]
chlchill1<-as.numeric(format(round(mean(fixef(chl.mod, pars="chill1", summary=FALSE)), digits=1), nsmall=1)) # -0.06
chlchill1sd<-as.numeric(format(round(mean(fixef(chl.mod, pars="chill1")[2]), digits=1), nsmall=1)) # 0.84
#chlchill1sd <- chlchill1sd[2] - chlchill1sd[1]
chlchill2<-as.numeric(format(round(mean(fixef(chl.mod, pars="chill2", summary=FALSE)), digits=1), nsmall=1)) # 0.43
chlchill2sd<-as.numeric(format(round(mean(fixef(chl.mod, pars="chill2")[2]), digits=1), nsmall=1)) # 0.91
chltxchill1 <- as.numeric(format(round(mean(fixef(chl.mod, pars="tx:chill1", summary=FALSE)), digits=1), nsmall=1))
chltxchill1sd <-as.numeric(format(round(mean(fixef(chl.mod, pars="tx:chill1")[2]), digits=1), nsmall=1)) 
chltxchill1 <- round(mean(fixef(chl.mod, pars="tx", summary=FALSE)) + mean(fixef(chl.mod, pars="chill1", summary=FALSE)) + mean(fixef(chl.mod, pars="tx:chill1", summary=FALSE)), digits=1)  

chltxchill2<-as.numeric(format(round(mean(fixef(chl.mod, pars="tx:chill2", summary=FALSE)), digits=1), nsmall=1))
chltxchill2sd<-as.numeric(format(round(mean(fixef(chl.mod, pars="tx:chill2")[2]), digits=1), nsmall=1)) # 1.07
#chltxchill2sd <- chltxchill2sd[2] - chltxchill2sd[1]
chltxchill2 <- round(mean(fixef(chl.mod, pars="tx", summary=FALSE)) + mean(fixef(chl.mod, pars="chill2", summary=FALSE)) + mean(fixef(chl.mod, pars="tx:chill2", summary=FALSE)), digits=1)   ### -2.03
...
toughtxchill1 <- round(mean(fixef(toughness.mod, pars="tx", summary=FALSE)) + mean(fixef(toughness.mod, pars="chill1", summary=FALSE)) + mean(fixef(toughness.mod, pars="tx:chill1", summary=FALSE)), digits=1) ### -0.09
...
toughtxchill2 <- round(mean(fixef(toughness.mod, pars="tx", summary=FALSE)) + mean(fixef(toughness.mod, pars="chill2", summary=FALSE)) + mean(fixef(toughness.mod, pars="tx:chill2", summary=FALSE)), digits=1) ### -0.08

### Thick Model - THICKNESS DECREASES ACROSS ALL CHILL TXs, ESP 4 & 8 wks
thicktx<-as.numeric(format(round(mean(fixef(thickness.mod, pars="tx", summary=FALSE)), digits=1), nsmall=1)) ### -8.9
thicktxsd<-as.numeric(format(round(mean(fixef(thickness.mod, pars="tx")[2]), digits=1), nsmall=1)) # 3.74
#thicktxsd <- thicktxsd[2] - thicktxsd[1]
thickchill1<-as.numeric(format(round(mean(fixef(thickness.mod, pars="chill1", summary=FALSE)), digits=1), nsmall=1)) ### 7.21
thickchill1sd<-as.numeric(format(round(mean(fixef(thickness.mod, pars="chill1")[2]), digits=1), nsmall=1)) # 6.55
#thickchill1sd <- thickchill1sd[2] - thickchill1sd[1]
thickchill2<-as.numeric(format(round(mean(fixef(thickness.mod, pars="chill2", summary=FALSE)), digits=1), nsmall=1)) ### -8.38
thickchill2sd<-as.numeric(format(round(mean(fixef(thickness.mod, pars="chill2")[2]), digits=1), nsmall=1)) # 7.48
#thickchill2sd <- thickchill2sd[2] - thickchill2sd[1]
thicktxchill1<-as.numeric(format(round(mean(fixef(thickness.mod, pars="tx:chill1", summary=FALSE)), digits=1), nsmall=1))
thicktxchill1sd<-as.numeric(format(round(mean(fixef(thickness.mod, pars="tx:chill1")[2]), digits=1), nsmall=1)) # 5.31
#thicktxchill1sd <- thicktxchill1sd[2] - thicktxchill1sd[1]
thicktxchill1 <- round(mean(fixef(thickness.mod, pars="tx", summary=FALSE)) + mean(fixef(thickness.mod, pars="chill1", summary=FALSE)) + mean(fixef(thickness.mod, pars="tx:chill1", summary=FALSE)), digits=1) # -3.5

thicktxchill2<-as.numeric(format(round(mean(fixef(thickness.mod, pars="tx:chill2", summary=FALSE)), digits=1), nsmall=1))
thicktxchill2sd<-as.numeric(format(round(mean(fixef(thickness.mod, pars="tx:chill2")[2]), digits=1), nsmall=1)) # 5.25
#thicktxchill2sd <- thicktxchill2sd[2] - thicktxchill2sd[1]
thicktxchill2 <- round(mean(fixef(thickness.mod, pars="tx", summary=FALSE)) + mean(fixef(thickness.mod, pars="chill2", summary=FALSE)) + mean(fixef(thickness.mod, pars="tx:chill2", summary=FALSE)), digits=1) ### -15.78

if(FALSE){
### Ht 60 day Model - Not very intersting, chilling increases growth but nothing with TX
httx<-as.numeric(format(round(mean(fixef(htdiff.mod, pars="tx", summary=FALSE)), digits=1), nsmall=1)) # -0.44
httxsd<-as.numeric(format(round(mean(fixef(htdiff.mod, pars="tx")[2]), digits=1), nsmall=1)) # 0.98
#httxsd<- httxsd[2] - httxsd[1]
htchill1<-as.numeric(format(round(mean(fixef(htdiff.mod, pars="chill1", summary=FALSE)), digits=1), nsmall=1)) ### 2.81
htchill1sd<-as.numeric(format(round(mean(fixef(htdiff.mod, pars="chill1")[2]), digits=1), nsmall=1)) # 1.55
#htchill1sd<- htchill1sd[2] - htchill1sd[1]
htchill2<-as.numeric(format(round(mean(fixef(htdiff.mod, pars="chill2", summary=FALSE)), digits=1), nsmall=1)) ### 1.32
htchill2sd<-as.numeric(format(round(mean(fixef(htdiff.mod, pars="chill2")[2]), digits=1), nsmall=1)) # 1.21
#htchill2sd<- htchill2sd[2] - htchill2sd[1]
httxchill1<-as.numeric(format(round(mean(fixef(htdiff.mod, pars="tx:chill1", summary=FALSE)), digits=1), nsmall=1))
httxchill1sd<-as.numeric(format(round(mean(fixef(htdiff.mod, pars="tx:chill1")[2]), digits=1), nsmall=1)) # 1.48
#httxchill1sd<- httxchill1sd[2] - httxchill1sd[1]
httxchill1 <- httx + htchill1 + httxchill1 # 0.36

httxchill2<-as.numeric(format(round(mean(fixef(htdiff.mod, pars="tx:chill2", summary=FALSE)), digits=1), nsmall=1))
httxchill2sd<-as.numeric(format(round(mean(fixef(htdiff.mod, pars="tx:chill2")[2]), digits=1), nsmall=1)) # 1.46
#httxchill2sd<- httxchill2sd[2] - httxchill2sd[1]
httxchill2 <- httx + htchill2 + httxchill2 # 0.68
}

### Ht final Model 
httx<-as.numeric(format(round(mean(fixef(htdiff.mod, pars="tx", summary=FALSE)), digits=1), nsmall=1)) ### 5.06
httxsd<-as.numeric(format(round(mean(fixef(htdiff.mod, pars="tx")[2]), digits=1), nsmall=1)) # 4.38
#httxsd <- httxsd[2] - httxsd[1]
htchill1<-as.numeric(format(round(mean(fixef(htdiff.mod, pars="chill1", summary=FALSE)), digits=1), nsmall=1)) ### 2.81
htchill1sd<-as.numeric(format(round(mean(fixef(htdiff.mod, pars="chill1")[2]), digits=1), nsmall=1)) # 1.55
#htchill1sd<- htchill1sd[2] - htchill1sd[1]
...
httxchill1sd<-as.numeric(format(round(mean(fixef(htdiff.mod, pars="tx:chill1")[2]), digits=1), nsmall=1)) # 1.48
#httxchill1sd<- httxchill1sd[2] - httxchill1sd[1]
httxchill1 <- round(mean(fixef(htdiff.mod, pars="tx", summary=FALSE)) + mean(fixef(htdiff.mod, pars="chill1", summary=FALSE)) + mean(fixef(htdiff.mod, pars="tx:chill1", summary=FALSE)), digits=1) # 0.36

httxchill2<-as.numeric(format(round(mean(fixef(htdiff.mod, pars="tx:chill2", summary=FALSE)), digits=1), nsmall=1))
httxchill2sd<-as.numeric(format(round(mean(fixef(htdiff.mod, pars="tx:chill2")[2]), digits=1), nsmall=1)) # 1.46
#httxchill2sd<- httxchill2sd[2] - httxchill2sd[1]
httxchill2 <- round(mean(fixef(htdiff.mod, pars="tx", summary=FALSE)) + mean(fixef(htdiff.mod, pars="chill2", summary=FALSE)) + mean(fixef(htdiff.mod, pars="tx:chill2", summary=FALSE)), digits=1)   # 0.68


### Total biomass Model - TX DECREASES BIOMASS BUT CHILLING CAN COMPENSATE!!!
totbiomasstx<-as.numeric(format(round(mean(fixef(totbiomass.mod, pars="tx", summary=FALSE)), digits=1), nsmall=1)) ### -3.45
totbiomasstxsd<-as.numeric(format(round(mean(fixef(totbiomass.mod, pars="tx")[2]), digits=1), nsmall=1))  # 2.78
#totbiomasstxsd <- totbiomasstxsd[2] - totbiomasstxsd[1]
totbiomasschill1<-as.numeric(format(round(mean(fixef(totbiomass.mod, pars="chill1", summary=FALSE)), digits=1), nsmall=1)) # 0.38
totbiomasschill1sd<-as.numeric(format(round(mean(fixef(totbiomass.mod, pars="chill1")[2]), digits=1), nsmall=1)) # 2.91
#totbiomasschill1sd <- totbiomasschill1sd[2] - totbiomasschill1sd[1]
totbiomasschill2<-as.numeric(format(round(mean(fixef(totbiomass.mod, pars="chill2", summary=FALSE)), digits=1), nsmall=1)) # 2.59
totbiomasschill2sd<-as.numeric(format(round(mean(fixef(totbiomass.mod, pars="chill2")[2]), digits=1), nsmall=1)) # 3.04
#totbiomasschill2sd <- totbiomasschill2sd[2] - totbiomasschill2sd[1]
totbiomasstxchill1<-as.numeric(format(round(mean(fixef(totbiomass.mod, pars="tx:chill1", summary=FALSE)), digits=1), nsmall=1))
totbiomasstxchill1sd<-as.numeric(format(round(mean(fixef(totbiomass.mod, pars="tx:chill1")[2]), digits=1), nsmall=1)) #  4.04
#totbiomasstxchill1sd <- totbiomasstxchill1sd[2] - totbiomasstxchill1sd[1]
totbiomasstxchill1 <- round(mean(fixef(totbiomass.mod, pars="tx", summary=FALSE)) + mean(fixef(totbiomass.mod, pars="chill1", summary=FALSE)) + mean(fixef(totbiomass.mod, pars="tx:chill1", summary=FALSE)), digits=1) # -3.62

totbiomasstxchill2<-as.numeric(format(round(mean(fixef(totbiomass.mod, pars="tx:chill2", summary=FALSE)), digits=1), nsmall=1))
totbiomasstxchill2sd<-as.numeric(format(round(mean(fixef(totbiomass.mod, pars="tx:chill2")[2]), digits=1), nsmall=1)) #  3.97
#totbiomasstxchill2sd <- totbiomasstxchill2sd[2] - totbiomasstxchill2sd[1]
totbiomasstxchill2 <- round(mean(fixef(totbiomass.mod, pars="tx", summary=FALSE)) + mean(fixef(totbiomass.mod, pars="chill2", summary=FALSE)) + mean(fixef(totbiomass.mod, pars="tx:chill2", summary=FALSE)), digits=1) # 2.88


### Root to Shoot Model - TX REDUCES ROOT MASS
roottoshoottx<-as.numeric(format(round(mean(fixef(roottoshoot.mod, pars="tx", summary=FALSE)), digits=1), nsmall=1)) ### -0.18
roottoshoottxsd<-as.numeric(format(round(mean(fixef(roottoshoot.mod, pars="tx")[2]), digits=1), nsmall=1)) # 0.15
#roottoshoottxsd <- roottoshoottxsd[2] - roottoshoottxsd[1]
roottoshootchill1<-as.numeric(format(round(mean(fixef(roottoshoot.mod, pars="chill1", summary=FALSE)), digits=1), nsmall=1)) #    -0.03
roottoshootchill1sd<-as.numeric(format(round(mean(fixef(roottoshoot.mod, pars="chill1")[2]), digits=1), nsmall=1)) # 0.14
#roottoshootchill1sd <- roottoshootchill1sd[2] - roottoshootchill1sd[1]
roottoshootchill2<-as.numeric(format(round(mean(fixef(roottoshoot.mod, pars="chill2", summary=FALSE)), digits=1), nsmall=1)) #    -0.16
roottoshootchill2sd<-as.numeric(format(round(mean(fixef(roottoshoot.mod, pars="chill2")[2]), digits=1), nsmall=1)) # 0.17
#roottoshootchill2sd <- roottoshootchill2sd[2] - roottoshootchill2sd[1]
roottoshoottxchill1<-as.numeric(format(round(mean(fixef(roottoshoot.mod, pars="tx:chill1", summary=FALSE)), digits=1), nsmall=1))
roottoshoottxchill1sd<-as.numeric(format(round(mean(fixef(roottoshoot.mod, pars="tx:chill1")[2]), digits=1), nsmall=1)) # 0.31
#roottoshoottxchill1sd <- roottoshoottxchill1sd[2] - roottoshoottxchill1sd[1]
roottoshoottxchill1 <- round(mean(fixef(roottoshoot.mod, pars="tx", summary=FALSE)) + mean(fixef(roottoshoot.mod, pars="chill1", summary=FALSE)) + mean(fixef(roottoshoot.mod, pars="tx:chill1", summary=FALSE)), digits=1) # -0.11

roottoshoottxchill2<-as.numeric(format(round(mean(fixef(roottoshoot.mod, pars="tx:chill2", summary=FALSE)), digits=1), nsmall=1))
roottoshoottxchill2sd<-as.numeric(format(round(mean(fixef(roottoshoot.mod, pars="tx:chill2")[2]), digits=1), nsmall=1)) # 0.23
#roottoshoottxchill2sd <- roottoshoottxchill2sd[2] - roottoshoottxchill2sd[1]
roottoshoottxchill2 <- round(mean(fixef(roottoshoot.mod, pars="tx", summary=FALSE)) + mean(fixef(roottoshoot.mod, pars="chill2", summary=FALSE)) + mean(fixef(roottoshoot.mod, pars="tx:chill2", summary=FALSE)), digits=1) ### -0.29

### Simple models
bbdat <- read.csv("output/clean_dvr_traits.csv")
bb.mod <- lm(budburst ~ chill1 + chill2, data=bbdat)
simpbbchill1 <- as.numeric(format(round(summary(bb.mod)$coef[2,1], digits=1), nsmall=1))
simpbbchillsd1 <- as.numeric(format(round(summary(bb.mod)$coef[2,2], digits=1), nsmall=1))
simpbbchill2 <- as.numeric(format(round(summary(bb.mod)$coef[3,1], digits=1), nsmall=1))
simpbbchillsd2 <- as.numeric(format(round(summary(bb.mod)$coef[3,2], digits=1), nsmall=1))

dvr.mod <- lm(dvr ~ chill1 + chill2, data=bbdat)
simpdvrchill1 <- as.numeric(format(round(summary(dvr.mod)$coef[2,1], digits=1), nsmall=1))
simpdvrchillsd1 <- as.numeric(format(round(summary(dvr.mod)$coef[2,2], digits=1), nsmall=1))
simpdvrchill2 <- as.numeric(format(round(summary(dvr.mod)$coef[3,1], digits=1), nsmall=1))
simpdvrchillsd2 <- as.numeric(format(round(summary(dvr.mod)$coef[3,2], digits=1), nsmall=1))
...
\begin{enumerate}
\item  With warming temperatures, spring phenology (i.e., budburst and leafout) is advancing. Late spring freezes, however, may not advance at the same rate, leading to an increase in freezes that occur after trees initiate budburst---known as false springs---with continued warming. Understanding and predicting false springs with climate change requires understanding both how warming shifts budburst and the impacts of false springs on plant tissue. In particular, increasing research suggests warming winters may delay budburst through reduced chilling, which may also cause plants to leaf out slower or incompletely, subsequently decreasing spring freeze tolerance and potentially leading to higher damage from false spring events. 
\item Here, we assessed the effects of over-winter chilling and false spring events on sapling phenology, growth and tissue traits, across eight temperate tree and shrub species in a lab experiment. 
\item We found that false springs slowed subsequent budburst and leafout---extending the period of greatest risk for freeze damage, which increased damage to the shoot apical meristem, and decreased leaf toughness, leaf thickness and chlorophyll content. Longer chilling accelerated budburst and leafout, even under false spring conditions, thus chilling compensated for the adverse effects of false springs on phenology. Despite the effect of chilling on phenology, it did not cause any major re-ordering in the sequence of species leafout. We therefore expect climate change to reshape forest communities not through temporal reassembly but rather through impacts on growth and leaf traits from the coupled effects of false springs with decreases in over-winter chilling under future climate change scenarios. 

\item \textbf{Synthesis:} With climate change and warming temperatures, over-winter chilling is anticipated to decrease and false springs are predicted to increase in certain regions. This combination could greatly impact plant performance, survival and shape species distributions, ultimately affecting important processes such as carbon uptake and nutrient cycling. 
\end{enumerate}
...
The combination of species- and lifestage-level differences in responses to false springs, chilling and climate change could reshape the temporal assembly of forest communities. Species typically leafout in a similar sequence, with understory species leafing out earlier and higher canopy trees leafing out last but many studies are predicting substantial shifts in chronological order and reassembly of species' leafout with climate change \citep{Roberts2015, Laube2014}. As warming increases winter temperatures and false spring prevalence, phenological cues and their interactions are anticipated to also change, which could greatly alter competition and recruitment among forest species for early season resources and ultimately impact species diversity and carbon uptake in temperate forests.
  
Here, we assessed the effects of over-winter chilling length and false springs on sapling phenology and growth across eight temperate tree and shrub species. We exposed individuals to different levels of over-winter chilling crossed with a false spring event in growth chambers, and then following individuals for a growing season we asked: (1) How does over-winter chilling impact phenology, growth and physical leaf traits (2) how do false spring events impact phenology, growth and physical leaf traits and (3) how does the interaction between chilling and false springs impact community structure and phenological order?
...
%EMW11Sep: first sexpr needs a decimal
False springs impacted growth habit and shoot growth but not total biomass. Across all chilling treatments, especially for the four and eight week chilling treatments, false springs led to more damage to the shoot apical meristem (4 weeks: \Sexpr{meritx.perc}\% increase in probability of damage under false spring treatment or \Sexpr{meritx} $\pm$ \Sexpr{meritxsd}; 6 weeks: \Sexpr{meritxchill1.perc}\% or a \Sexpr{meritxchill1} $\pm$ \Sexpr{meritxchill1sd}; and 8 weeks: \Sexpr{meritxchill2.perc}\% or a \Sexpr{meritxchill2} $\pm$ \Sexpr{meritxchill2sd}; Figure \ref{fig:mugrowth}\textbf{a} and Table \ref{tab:suppmodmeri}). Shoot growth over the growing season increased with eight weeks of chilling (\Sexpr{htchill2} $\pm$ \Sexpr{htchill2sd} cm) but growth did not increase for eight weeks of chilling under false spring conditions (\Sexpr{httxchill2} $\pm$ \Sexpr{httxchill2sd} cm; Figure \ref{fig:mugrowth}\textbf{b} and Table \ref{tab:suppmodht}). False springs led to slightly lower total biomasses when saplings were exposed to only four weeks of chilling (\Sexpr{totbiomasstx} $\pm$ \Sexpr{totbiomasstxsd} g) but there was very little change in total biomass under false spring conditions (compared to the no false spring) for both the six (\Sexpr{totbiomasstxchill1} $\pm$ \Sexpr{totbiomasstxchill1sd} g) and the eight weeks of chilling treatments (\Sexpr{totbiomasstxchill2} $\pm$ \Sexpr{totbiomasschill2sd} g; Figure \ref{fig:mutotbio} and Table \ref{tab:suppmodtotbio}).
  
  %EMW11Sep: a few spots here too where sig digits in PDF are off ... and the next paragraph.. just check the methods for 0.1 type digits.
False springs also affected physical leaf traits. False spring treatments decreased leaf toughness across all chilling treatments (4 weeks: \Sexpr{toughtx} $\pm$ \Sexpr{toughtxsd} N; 6 weeks: \Sexpr{toughtxchill1} $\pm$ \Sexpr{toughtxchill1sd} N; and 8 weeks: \Sexpr{toughtxchill2} $\pm$ \Sexpr{toughtxchill2sd} N; Figure \ref{fig:muleaf}\textbf{a} and Table \ref{tab:suppmodtough}) and decreased chlorophyll content in leaves with six and eight weeks of chilling (6 weeks: \Sexpr{chltxchill1} $\pm$ \Sexpr{chltxchill1sd} mg/cm\textsuperscript{2}; and especially for 8 weeks: \Sexpr{chltxchill2} $\pm$ \Sexpr{chltxchill2sd} mg/cm\textsuperscript{2}; Figure \ref{fig:muchl} and Table \ref{tab:suppmodchl}). Additionally, false springs led to decreased leaf thickness across four and eight weeks of chilling treatments, but there was little change for the six weeks of chilling treatment (4 weeks: \Sexpr{thicktx} $\pm$ \Sexpr{thicktxsd} $\mu$m; 6 weeks: \Sexpr{thicktxchill1} $\pm$ \Sexpr{thicktxchill1sd} $\mu$m; and 8 weeks: \Sexpr{thicktxchill2} $\pm$ \Sexpr{thicktxchill2sd} $\mu$m for eight weeks of chilling; Figure \ref{fig:muleaf}\textbf{b} and Table \ref{tab:suppmodthick}). 
...
\subsection*{False springs and chilling interactively determined risk and damage}  %EMW11Sep: first sentence here is a general statement from the lit? I think so, would be clearer if you add a citation or two.
...
{\begin{figure} [H]
  ...
  -\caption{Effects of false spring treatment, six weeks of chilling and eight weeks of chilling relative to four weeks of chilling with no false spring on a) duration of vegetative risk (days) and b) growing season length (days). Larger, blue dots represent overall estimates across all species, while smaller dots are estimates for each species. Dots and thin lines show means and 90\% uncertainty intervals and thicker lines show 50\% uncertainty intervals.}\label{fig:muphen} %EMWAug14 -- for first figure add the baseline (4 weeks chill x no false spring) that they're all relative to?
  -\end{center}
  -\end{figure}}
  ...
  -\caption{Effects of false spring treatment, six weeks of chilling and eight weeks of chilling on a) shoot apical meristem damage and b) total shoot growth (cm). Larger, blue dots represent overall estimates across all species, while smaller dots are estimates for each species. Dots and thin lines show means and 90\% uncertainty intervals and thicker lines show 50\% uncertainty intervals. }\label{fig:mugrowth}
  -\end{center}
  -\end{figure}}
  ...
  -\caption{Effects of false spring treatment, six weeks of chilling and eight weeks of chilling on a) leaf toughness (N) and b) leaf thickness ($\mu$m). Larger, blue dots represent overall estimates across all species, while smaller dots are estimates for each species. Dots and thin lines show means and 90\% uncertainty intervals and thicker lines show 50\% uncertainty intervals. }\label{fig:muleaf}
  -\end{center}
  -\end{figure}}
