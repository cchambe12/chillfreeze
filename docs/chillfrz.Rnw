...
@
%EMWSep21: Watch out for sad red error in PDF around here! 
...
%%  4) include a final point headed ‘Synthesis’, which sums up the paper’s key message in generic terms that can be understood by non-specialists, indicating clearly how this study has advanced ecological understanding. ... %EMWSep21: Hmm, I think the synthesis is supposed to be more about YOUR findings, while it feels more general just now. See what you think of my edits. 
...
\subsection*{False springs and chilling both determined risk and damage}  %EMW11Sep: first sentence here is a general statement from the lit? I think so, would be clearer if you add a citation or two.
...
%EMWSep21: Changed the below ... since we don't look beyond lifestage we have to be careful to clarify what our results show and what our results plus the literature to date show .... 
