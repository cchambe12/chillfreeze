...
dvrtx<-round(mean(fixef(dvr.mod, pars="tx", summary=FALSE)), digits=1) ### 2.97
dvrtxsd<-round(mean(fixef(dvr.mod, pars="tx")[2]), digits=1) 
dvrchill1<-round(mean(fixef(dvr.mod, pars="chill1", summary=FALSE)), digits=1) # -0.53
dvrchill1sd<-round(mean(fixef(dvr.mod, pars="chill1")[2]), digits=1)
dvrchill2<-round(mean(fixef(dvr.mod, pars="chill2", summary=FALSE)), digits=1) ### -2.67
dvrchill2sd<-round(mean(fixef(dvr.mod, pars="chill2")[2]), digits=1) # 1.14

dvrtxchill1<-round(mean(fixef(dvr.mod, pars="tx:chill1", summary=FALSE)), digits=1) 
dvrtxchill1sd<-round(mean(fixef(dvr.mod, pars="tx:chill1")[2]), digits=1) # 1.14
dvrtxchill1 <- dvrtx + dvrchill1 + dvrtxchill1 ### 1.53

dvrtxchill2<-round(mean(fixef(dvr.mod, pars="tx:chill2", summary=FALSE)), digits=1) 
dvrtxchill2sd<-round(mean(fixef(dvr.mod, pars="tx:chill2")[2]), digits=1) # 1.08
dvrtxchill2 <- dvrtx + dvrchill2 + dvrtxchill2 # 0.92


### Gslength Model - CHILLING EXTENDS GS!!!! AND CAN COMPENSATE FOR TX!
gslengthtx<-round(mean(fixef(gslength.modlo, pars="tx", summary=FALSE)), digits=1) # -2.9
gslengthtxsd<-round(mean(fixef(gslength.modlo, pars="tx")[2]), digits=1) # 5.52
gslengthchill1<-round(mean(fixef(gslength.modlo, pars="chill1", summary=FALSE)), digits=1) ### 3.11
gslengthchill1sd<-round(mean(fixef(gslength.modlo, pars="chill1")[2]), digits=1) # 4.97
gslengthchill2<-round(mean(fixef(gslength.modlo, pars="chill2", summary=FALSE)), digits=1) ### -6.82
gslengthchill2sd<-round(mean(fixef(gslength.modlo, pars="chill2")[2]), digits=1) # 5.11
gslengthtxchill1<-round(mean(fixef(gslength.modlo, pars="tx:chill1", summary=FALSE)), digits=1) 
gslengthtxchill1sd<-round(mean(fixef(gslength.modlo, pars="tx:chill1")[2]), digits=1) # 6.63
gslengthtxchill1 <- gslengthtx + gslengthchill1 + gslengthtxchill1 # -13.91

gslengthtxchill2<-round(mean(fixef(gslength.modlo, pars="tx:chill2", summary=FALSE)), digits=1)
gslengthtxchill2sd<-round(mean(fixef(gslength.modlo, pars="tx:chill2")[2]), digits=1) # 6.97
gslengthtxchill2 <- gslengthtx + gslengthchill2 + gslengthtxchill2 ### -19.08

### Meristem Model - MERISTEM DAMAGE ACROSS CHILL TXs!!
meritx<-round(mean(fixef(meri.mod, pars="tx", summary=FALSE)), digits=1) ### 2.07
meritx.perc <- round((meritx/4)*100, digits=1)
meritxsd <- round(mean(fixef(meri.mod, pars="tx")[2]), digits=1) # 0.97
merichill1<-round(mean(fixef(meri.mod, pars="chill1", summary=FALSE)), digits=1) # -0.53
merichill1sd<-round(mean(fixef(meri.mod, pars="chill1")[2]), digits=1) # 1.88
merichill2<-round(mean(fixef(meri.mod, pars="chill2", summary=FALSE)), digits=1) # -0.18
merichill2sd<-round(mean(fixef(meri.mod, pars="chill2")[2]), digits=1) # 1.17
#merichill2sd <- merichill2sd[2] - merichill2sd[1]
meritxchill1<-round(mean(fixef(meri.mod, pars="tx:chill1", summary=FALSE)), digits=1) 
meritxchill1sd<-round(mean(fixef(meri.mod, pars="tx:chill1")[2]), digits=1) # 1.42
...
meritxchill2<-round(mean(fixef(meri.mod, pars="tx:chill2", summary=FALSE)), digits=1) 
meritxchill2sd<-round(mean(fixef(meri.mod, pars="tx:chill2")[2]), digits=1) # 1.31
...
chltx<-round(mean(fixef(chl.mod, pars="tx", summary=FALSE)), digits=1) # -0.35
chltxsd<-round(mean(fixef(chl.mod, pars="tx")[2]), digits=1) # 0.77
#chltxsd <- chltxsd[2] - chltxsd[1]
chlchill1<-round(mean(fixef(chl.mod, pars="chill1", summary=FALSE)), digits=1) # -0.06
chlchill1sd<-round(mean(fixef(chl.mod, pars="chill1")[2]), digits=1) # 0.84
#chlchill1sd <- chlchill1sd[2] - chlchill1sd[1]
chlchill2<-round(mean(fixef(chl.mod, pars="chill2", summary=FALSE)), digits=1) # 0.43
chlchill2sd<-round(mean(fixef(chl.mod, pars="chill2")[2]), digits=1) # 0.91
chltxchill1 <- round(mean(fixef(chl.mod, pars="tx:chill1", summary=FALSE)), digits=1)
chltxchill1sd <-round(mean(fixef(chl.mod, pars="tx:chill1")[2]), digits=1) 
chltxchill1 <- chltx + chlchill1 + chltxchill1  

chltxchill2<-round(mean(fixef(chl.mod, pars="tx:chill2", summary=FALSE)), digits=1)
chltxchill2sd<-round(mean(fixef(chl.mod, pars="tx:chill2")[2]), digits=1) # 1.07
...
toughtx<-round(mean(fixef(toughness.mod, pars="tx", summary=FALSE)), digits=1) ### -0.05
toughtxsd<-round(mean(fixef(toughness.mod, pars="tx")[2]), digits=1) # 0.02
#toughtxsd <- toughtxsd[2] - toughtxsd[1]
toughchill1<-round(mean(fixef(toughness.mod, pars="chill1", summary=FALSE)), digits=1) ### -0.06
toughchill1sd<-round(mean(fixef(toughness.mod, pars="chill1")[2]), digits=1) # 0.02
#toughchill1sd <- toughchill1sd[2] - toughchill1sd[1]
toughchill2<-round(mean(fixef(toughness.mod, pars="chill2", summary=FALSE)), digits=1) ### -0.05
toughchill2sd<-round(mean(fixef(toughness.mod, pars="chill2")[2]), digits=1) # 0.02
#toughchill2sd <- toughchill2sd[2] - toughchill2sd[1]
toughtxchill1<-round(mean(fixef(toughness.mod, pars="tx:chill1", summary=FALSE)), digits=1) 
toughtxchill1sd<-round(mean(fixef(toughness.mod, pars="tx:chill1")[2]), digits=1) # 0.03
#toughtxchill1sd <- toughtxchill1sd[2] - toughtxchill1sd[1]
toughtxchill1 <- toughtx + toughchill1 + toughtxchill1 ### -0.09

toughtxchill2<-round(mean(fixef(toughness.mod, pars="tx:chill2", summary=FALSE)), digits=1)
toughtxchill2sd<-round(mean(fixef(toughness.mod, pars="tx:chill2")[2]), digits=1) # 0.03
...
thicktx<-round(mean(fixef(thickness.mod, pars="tx", summary=FALSE)), digits=1) ### -8.9
thicktxsd<-round(mean(fixef(thickness.mod, pars="tx")[2]), digits=1) # 3.74
#thicktxsd <- thicktxsd[2] - thicktxsd[1]
thickchill1<-round(mean(fixef(thickness.mod, pars="chill1", summary=FALSE)), digits=1) ### 7.21
thickchill1sd<-round(mean(fixef(thickness.mod, pars="chill1")[2]), digits=1) # 6.55
#thickchill1sd <- thickchill1sd[2] - thickchill1sd[1]
thickchill2<-round(mean(fixef(thickness.mod, pars="chill2", summary=FALSE)), digits=1) ### -8.38
thickchill2sd<-round(mean(fixef(thickness.mod, pars="chill2")[2]), digits=1) # 7.48
#thickchill2sd <- thickchill2sd[2] - thickchill2sd[1]
thicktxchill1<-round(mean(fixef(thickness.mod, pars="tx:chill1", summary=FALSE)), digits=1)
thicktxchill1sd<-round(mean(fixef(thickness.mod, pars="tx:chill1")[2]), digits=1) # 5.31
#thicktxchill1sd <- thicktxchill1sd[2] - thicktxchill1sd[1]
thicktxchill1 <- thicktx + thickchill1 + thicktxchill1 # -3.5

thicktxchill2<-round(mean(fixef(thickness.mod, pars="tx:chill2", summary=FALSE)), digits=1)
thicktxchill2sd<-round(mean(fixef(thickness.mod, pars="tx:chill2")[2]), digits=1) # 5.25
...
httx<-round(mean(fixef(htdiff.mod, pars="tx", summary=FALSE)), digits=1) # -0.44
httxsd<-round(mean(fixef(htdiff.mod, pars="tx")[2]), digits=1) # 0.98
#httxsd<- httxsd[2] - httxsd[1]
htchill1<-round(mean(fixef(htdiff.mod, pars="chill1", summary=FALSE)), digits=1) ### 2.81
htchill1sd<-round(mean(fixef(htdiff.mod, pars="chill1")[2]), digits=1) # 1.55
#htchill1sd<- htchill1sd[2] - htchill1sd[1]
htchill2<-round(mean(fixef(htdiff.mod, pars="chill2", summary=FALSE)), digits=1) ### 1.32
htchill2sd<-round(mean(fixef(htdiff.mod, pars="chill2")[2]), digits=1) # 1.21
#htchill2sd<- htchill2sd[2] - htchill2sd[1]
httxchill1<-round(mean(fixef(htdiff.mod, pars="tx:chill1", summary=FALSE)), digits=1)
httxchill1sd<-round(mean(fixef(htdiff.mod, pars="tx:chill1")[2]), digits=1) # 1.48
#httxchill1sd<- httxchill1sd[2] - httxchill1sd[1]
httxchill1 <- httx + htchill1 + httxchill1 # 0.36

httxchill2<-round(mean(fixef(htdiff.mod, pars="tx:chill2", summary=FALSE)), digits=1)
httxchill2sd<-round(mean(fixef(htdiff.mod, pars="tx:chill2")[2]), digits=1) # 1.46
#httxchill2sd<- httxchill2sd[2] - httxchill2sd[1]
httxchill2 <- httx + htchill2 + httxchill2 # 0.68
}

### Ht final Model 
httx<-round(mean(fixef(htdiff.mod, pars="tx", summary=FALSE)), digits=1) ### 5.06
httxsd<-round(mean(fixef(htdiff.mod, pars="tx")[2]), digits=1) # 4.38
#httxsd <- httxsd[2] - httxsd[1]
htchill1<-round(mean(fixef(htdiff.mod, pars="chill1", summary=FALSE)), digits=1) ### 2.81
htchill1sd<-round(mean(fixef(htdiff.mod, pars="chill1")[2]), digits=1) # 1.55
#htchill1sd<- htchill1sd[2] - htchill1sd[1]
...
httxchill1sd<-round(mean(fixef(htdiff.mod, pars="tx:chill1")[2]), digits=1) # 1.48
#httxchill1sd<- httxchill1sd[2] - httxchill1sd[1]
httxchill1 <- round(httx + htchill1 + httxchill1, digits=1) # 0.36
...
totbiomasstx<-round(mean(fixef(totbiomass.mod, pars="tx", summary=FALSE)), digits=1) ### -3.45
totbiomasstxsd<-round(mean(fixef(totbiomass.mod, pars="tx")[2]), digits=1)  # 2.78
#totbiomasstxsd <- totbiomasstxsd[2] - totbiomasstxsd[1]
totbiomasschill1<-round(mean(fixef(totbiomass.mod, pars="chill1", summary=FALSE)), digits=1) # 0.38
totbiomasschill1sd<-round(mean(fixef(totbiomass.mod, pars="chill1")[2]), digits=1) # 2.91
#totbiomasschill1sd <- totbiomasschill1sd[2] - totbiomasschill1sd[1]
totbiomasschill2<-round(mean(fixef(totbiomass.mod, pars="chill2", summary=FALSE)), digits=1) # 2.59
totbiomasschill2sd<-round(mean(fixef(totbiomass.mod, pars="chill2")[2]), digits=1) # 3.04
#totbiomasschill2sd <- totbiomasschill2sd[2] - totbiomasschill2sd[1]
totbiomasstxchill1<-round(mean(fixef(totbiomass.mod, pars="tx:chill1", summary=FALSE)), digits=1)
totbiomasstxchill1sd<-round(mean(fixef(totbiomass.mod, pars="tx:chill1")[2]), digits=1) #  4.04
...
totbiomasstxchill2<-round(mean(fixef(totbiomass.mod, pars="tx:chill2", summary=FALSE)), digits=1)
totbiomasstxchill2sd<-round(mean(fixef(totbiomass.mod, pars="tx:chill2")[2]), digits=1) #  3.97
...
roottoshoottx<-round(mean(fixef(roottoshoot.mod, pars="tx", summary=FALSE)), digits=1) ### -0.18
roottoshoottxsd<-round(mean(fixef(roottoshoot.mod, pars="tx")[2]), digits=1) # 0.15
#roottoshoottxsd <- roottoshoottxsd[2] - roottoshoottxsd[1]
roottoshootchill1<-round(mean(fixef(roottoshoot.mod, pars="chill1", summary=FALSE)), digits=1) #    -0.03
roottoshootchill1sd<-round(mean(fixef(roottoshoot.mod, pars="chill1")[2]), digits=1) # 0.14
#roottoshootchill1sd <- roottoshootchill1sd[2] - roottoshootchill1sd[1]
roottoshootchill2<-round(mean(fixef(roottoshoot.mod, pars="chill2", summary=FALSE)), digits=1) #    -0.16
roottoshootchill2sd<-round(mean(fixef(roottoshoot.mod, pars="chill2")[2]), digits=1) # 0.17
#roottoshootchill2sd <- roottoshootchill2sd[2] - roottoshootchill2sd[1]
roottoshoottxchill1<-round(mean(fixef(roottoshoot.mod, pars="tx:chill1", summary=FALSE)), digits=1)
roottoshoottxchill1sd<-round(mean(fixef(roottoshoot.mod, pars="tx:chill1")[2]), digits=1) # 0.31
...
roottoshoottxchill2<-round(mean(fixef(roottoshoot.mod, pars="tx:chill2", summary=FALSE)), digits=1)
roottoshoottxchill2sd<-round(mean(fixef(roottoshoot.mod, pars="tx:chill2")[2]), digits=1) # 0.23
...
%Understanding the intersection of warming winters and false spring risk is critical to predict how temperate forests will change in the future.
...
Warmer winters may also play a critical role in the future of forests as they directly impact one of the  major cues plants use to time budburst: over-winter cold temperatures (chilling), in addition to warming spring temperatures (forcing) and longer daylengths. Many temperate plants have evolved chilling requirements to avoid leafout during warm snaps in the middle of the winter, but with climate change, chilling requirements may not be met. If chilling is not met, plants may leaf out much slower or incompletely, which can in turn affect freeze tolerance. Thus studies of how false springs, and their impacts on forests, may shift with climate change also need to understand the interplay of warming winters and false spring risk. %EMW11Sep: Add citation about cues after first sentence. 
  
Understanding how the interplay between winter chilling and false springs may impact future forests requires knowing whether this interplay varies across species within a community. This is especially true if species have evolved along a trade-off of risking spring freezes for early access to resources. While a single-species perspective may predict all individuals to require high levels of chilling to delay budburst and ultimately diminish false spring risk, competition between species for nutrients, water and light resources in the early spring likely pushes some species---and some individuals within species---to leafout earlier \citep{Augspurger2013}. Young trees and understory species generally initiate budburst before canopy trees to benefit from higher light levels \citep {Augspurger2008, Vitasse2013}, which potentially puts these species and individuals at higher risk of freeze damage \citep{Vitasse2014}. Thus, successful forest recruitment requires seedlings and saplings to minimize false spring risk while maximizing growth. 
 
The combination of species- and lifestage-level differences in responses to false springs, chilling and climate change could reshape the temporal assembly of forest communities. Species typically leafout in a similar sequence, with understory species leafing out earlier and higher canopy trees leafing out last but many studies are predicting substantial shifts in chronological order and reassembly of species' leafout with climate change \citep{Roberts2015, Laube2014}. As warming increases winter temperatures and false spring prevalence, phenological cues and their interactions are anticipated to change, which could greatly alter competition and recruitment among forest species for early season resources and ultimately impact species diversity and carbon uptake in temperate forests.
...
\subsection*{Phenology and False Spring Treatment} %EMW11Sep: Add a citation for BBCH scale? So  then we're completely clear on which on we used?
...
\subsection*{Data analysis} %EMW11Sep: 4000 neff is oddly round given 6000 iterations -- are you sure that's correct?
...
{\begin{figure} [H]
  ...
  -\caption{Rank order of leafout across all species using (a) mean trends and (b) raw estimates. }\label{fig:rank}
  -\end{center}
  -\end{figure}}
