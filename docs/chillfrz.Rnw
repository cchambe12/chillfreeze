...
%% CJC 10 Dec, I cut this line to try and improve flow and include bit about chlorophyll and total biomass and photosynthesis and cue use: "The overall reductions in leaf quality could lead to an increase in risk from herbivory \citep{Onoda2011}, especially with climate change."
