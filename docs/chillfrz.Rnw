...
@
\section*{Abstract} %% Word limit is 300
...
% Don't know how to fit this in! I want to talk about how we have very little information on how the interaction of cue use impacts physiological traits. Photosynthetic capacity of leaves is shown to decrease with decreasing autumnal photoperiod cues under climate change \citep{Bauerle2012,Stinziano2017} but understanding the effects of spring phenologcial cue use on leaf quality needs to be further examined.
...
% I don't know where to fit in the interesting tidbit about leaf thickness leafout order grouping! It makes sense that thinner leaves would leafout earlier being less costly but not sure how to fit this in the discussion. Additionally, effects of false spring and chilling treatments did not impact growth or leaf traits based on rank, except for with leaf thickness where species generally grouped by leafout order.
...
{\begin{figure} [H]
  ...
  -\caption{Effects of false spring treatment, six weeks of chilling and four weeks of chilling on a) shoot apical meristem damage and b) total shoot growth as a metric of height (cm). Dots and thin lines show means and 90\% uncertainty intervals and thicker lines show 50\% uncertainty intervals. Larger blue dots represent overall estimates across all species, while smaller dots are estimates for each species. }\label{fig:mugrowth}
  -\end{center}
  -\end{figure}}
  ...
  {\begin{figure} [H]
  -\begin{center}
  -\includegraphics[width=18cm]{..//analyses/figures/mu_chlbiomass.pdf} 
  -\caption{Effects of false spring treatment, six weeks of chilling and four weeks of chilling on a) chlorophyll content (mg/cm\^2) and b) on total aboveground and belowground biomass (g). Dots and thin lines show means and 90\% uncertainty intervals and thicker lines show 50\% uncertainty intervals. Larger blue dots represent overall estimates across all species, while smaller dots are estimates for each species. }\label{fig:muleaf}
  -\end{center}
  -\end{figure}}
