...
\begin{align*}
y_i &= \alpha_{species[i]} + \beta_{tx_{species[i]}}X_tx + \beta_{chill1_{species[i]}}X_chill1 + \beta_{chill2_{species[i]}}X_chill2\\
&+ \beta_{txchill1_{species[i]}}X_txchill1 + \beta_{txchill2_{species[i]}}X_txchill2 + \epsilon_i\\,
\end{align*}
\begin{align*}
...
logit(p) &= \alpha_{species[i]} + \beta_{tx_{species[i]}}X_tx + \beta_{chill1_{species[i]}}X_chill1 + \beta_{chill2_{species[i]}}X_chill2\\
&+ \beta_{txchill1_{species[i]}}X_txchill1 + \beta_{txchill2_{species[i]}}X_txchill2 + \epsilon_i \nonumber\\,
\end{align*}
...
\item We found that false springs impacted both phenology and growth. 
  \begin{enumerate}
  \item Individuals exposed to the false spring treatment had longer duration of vegetative risks (XX) at the beginning of the season and generally initiated dormancy earlier at the end of the season (XX), except for the cohort that received only 4 weeks of over-winter chilling, which had a consistent growing season length (XX). 
...
\item Growth traits were affected differently.
  \begin{enumerate}
  \item Additionally, across all species and chilling treatments, individuals exposed to false springs experienced more damage to the shoot apical meristem and relied more on lateral shoot growth, rendering inefficient growth patterns. 
  \end{enumerate}
\end{enumerate}
...
{\begin{figure} [H]
  ...
  {\begin{figure} [H]
  -\begin{center}
  -\includegraphics[width=16cm]{..//analyses/figures/dvr_brms.pdf} %\label{fig:allmsmts}
  -\end{center}
  -\end{figure}}
  
  {\begin{figure} [H]
  -\begin{center}
  -\includegraphics[width=16cm]{..//analyses/figures/gslengthlo_brms.pdf} %\label{fig:allmsmts}
  -\end{center}
  -\end{figure}}
  
  {\begin{figure} [H]
  -\begin{center}
  -\includegraphics[width=16cm]{..//analyses/figures/meristem_brms.pdf} %\label{fig:allmsmts}
  -\end{center}
  -\end{figure}}
  
  {\begin{figure} [H]
  -\begin{center}
  -\includegraphics[width=12cm]{..//analyses/figures/chlavg.pdf} %\label{fig:allmsmts}
  -\end{center}
  -\end{figure}}
  
  {\begin{figure} [H]
  -\begin{center}
  -\includegraphics[width=16cm]{..//analyses/figures/toughness_brms.pdf} %\label{fig:allmsmts}
  -\end{center}
  -\end{figure}}
  
  {\begin{figure} [H]
  -\begin{center}
  -\includegraphics[width=12cm]{..//analyses/figures/thickness_brms.pdf} %\label{fig:allmsmts}
  -\end{center}
  -\end{figure}}
  
  {\begin{figure} [H]
  -\begin{center}
  -\includegraphics[width=16cm]{..//analyses/figures/htdiff_brms.pdf} %\label{fig:allmsmts}
  -\end{center}
  -\end{figure}}
  
  {\begin{figure} [H]
  -\begin{center}
  -\includegraphics[width=16cm]{..//analyses/figures/totbiomass_brms.pdf} %\label{fig:allmsmts}
  -\end{center}
  -\end{figure}}
  
  {\begin{figure} [H]
  -\begin{center}
  -\includegraphics[width=16cm]{..//analyses/figures/roottoshoot_brms.pdf} %\label{fig:allmsmts}
  -\end{center}
  -\end{figure}}
