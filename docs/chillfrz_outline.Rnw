...
\item With climate change advancing, chilling is predicted to decrease as winter temperatures warm, potentially impacting phenology and, ultimately, growth.
  \begin{enumerate}
  \item Deciduous trees and shrubs require a certain number of chilling hours in order to leave the endodormancy phase \citep{Charrier2015}. 
...
\item Phenology observations were taken every 2-3 days through full leaf expansion and then recorded weekly over the summer.
  ...
  \item Temperatures in the growth chamber were ramped down: 6pm to 10C, 8pm to 5C, 10pm to 0C, 12am to -3C, 3am to 0C, 4am to 5C, 6am to 10C and 8am temperatures rose again to 15C (Figure \ref{gccond}).
